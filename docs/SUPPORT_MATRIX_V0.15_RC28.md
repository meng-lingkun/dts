# QMigration V0.15.0-rc28 Support Matrix
...
5. Long-running 10–40 TB external kill/network/disk-pressure soak qualification; RC28 now covers deterministic commit-ambiguity/recovery windows in addition to RC27 durability failpoints.
