...
- update relocation/indirect after-images whose outer record type is `0x02` until preceding-insert linkage is implemented;
...
2. DB2 update-relocation (`0x02`) linkage, out-of-row multi-insert and pureScale qualification.
