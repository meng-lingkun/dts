# QMigration V0.15.0-rc7 Support Matrix
...
vendor API rather than a SQL/wire log API; RC7 uses this model for Db2
...
- INSERT / DELETE / UPDATE for ordinary non-value-compressed row images;
...
Fail-closed boundaries in RC7:

- value-compressed row images;
- out-of-row LOB log reconstruction;
...
2. DB2 value-compression, out-of-row LOB and compensation/savepoint log-format extension.
