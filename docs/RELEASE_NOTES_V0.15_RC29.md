# DTS V0.15.0-rc29 Release Notes
...
- `DTS_FAULT_PLAN` accepts `name=N@SIGKILL` in addition to deterministic error injection.
- `dts-chaos-qualify` now runs 10 scenarios.
