# DTS V0.15.0-rc41 Release Notes
...
- `DTS_METADATA_MAINTENANCE_ENABLED=true`
- `DTS_METADATA_MAINTENANCE_INTERVAL_MINUTES=10`
- `DTS_TASK_LOG_RETENTION_HOURS=168`
- `DTS_TASK_LOG_MAX_ROWS_PER_TASK=20000`
- `DTS_AUDIT_RETENTION_HOURS=2160`
- `DTS_AUDIT_MAX_ROWS=100000`
- `DTS_CDC_POSITION_RETENTION_HOURS=168`
- `DTS_CDC_POSITION_MAX_ROWS_PER_STREAM=4096`
- `DTS_METADATA_PRUNE_BATCH_ROWS=5000`
- `DTS_METADATA_PRUNE_MAX_BATCHES=4`
