...
3. GBase 8a Source CDC/transactional target apply; GBase 8s smart BLOB/CLOB historical image retrieval.
4. DB2 pureScale/multi-log-stream ordering and GaussDB multi-primary/hybrid DDL+DML boundaries.
5. Long-running 10–40 TB failure-injection/performance qualification across the primary migration paths.
